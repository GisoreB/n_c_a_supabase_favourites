...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFFDFDFDF);
  late Color primaryText = const Color(0xFF151A1D);
  late Color secondaryText = const Color(0xFF8B97A2);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF006793);
  late Color accent2 = const Color(0xFF002341);
  late Color accent3 = const Color(0xFFB22017);
  late Color accent4 = const Color(0xFFBCBCBC);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF002F72);
  late Color tertiary = const Color(0xFFF1281E);
  late Color alternate = const Color(0xFF2E313E);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF8B97A2);
  late Color primaryBackground = const Color(0xFF111417);
  late Color secondaryBackground = const Color(0xFF1A1F24);
  late Color accent1 = const Color(0xFF006793);
  late Color accent2 = const Color(0xFF002341);
  late Color accent3 = const Color(0xFFB22017);
  late Color accent4 = const Color(0xFF23272F);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xFFFCDC0C);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFFFFFFFF);
