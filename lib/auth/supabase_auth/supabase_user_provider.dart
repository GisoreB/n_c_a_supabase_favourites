...
class NCASupabaseFavouritesStarterSupabaseUser extends BaseAuthUser {
  NCASupabaseFavouritesStarterSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> nCASupabaseFavouritesStarterSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          NCASupabaseFavouritesStarterSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
